...
export const savedSpots: SavedSpot[] = [
  ...
  { id: "caffe-panna-irving", name: "Caffè Panna", address: "77 Irving Pl", lat: 40.7369641, lng: -73.9868018, kind: "cafe", visited: true },
  ...
  { id: "chili", name: "CHILI", address: "13 E 37th St", lat: 40.7501079, lng: -73.9820782, kind: "nice", visited: true, note: "Solo dined here a lot when I was living near Grand Central. Not as cute because it's in Midtown, but great schezuan food" },
  ...
  { id: "la-cabra", name: "La Cabra", address: "152 2nd Ave", lat: 40.7293547, lng: -73.9866878, kind: "cafe", visited: true },
  ...
  { id: "lindustrie", name: "L'industrie Pizzeria", address: "104 Christopher St", lat: 40.7332057, lng: -74.0049379, kind: "casual", visited: true, note: "Supposedly the best slice in NYC although I think it's overrated after waiting in an hour line lol" },
  { id: "little-collins", name: "Little Collins", address: "708 3rd Ave", lat: 40.7523935, lng: -73.9735028, kind: "cafe", visited: true },
