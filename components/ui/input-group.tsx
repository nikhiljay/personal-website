...
function focusInputGroupControl(group: HTMLElement) {
  group
    ...
    <div
      ...
      onClick={(e) => {
        ...
        if (e.currentTarget.parentElement) {
          focusInputGroupControl(e.currentTarget.parentElement)
        }
      }}
      {...props}
    />
