...
const IndexPage = () => (
  <Layout>
    ...
    />
    <div className="relative mx-auto max-w-xl py-28 px-4">
      <div className="flex justify-between items-center">
        <div className="flex items-center">
          ...
          />
          <div className="ml-4">
            <h1 className="text-3xl font-extrabold text-white antialiased -mb-1.5">Nikhil D'Souza</h1>
            <FaLocationArrow size={10} className="inline-block text-slate-400 mr-1" />
            <p className="inline-block text-slate-400 text-xs font-medium antialiased">San Francisco, CA</p>
          </div>
        </div>
