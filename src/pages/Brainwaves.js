    ...
    <div>
        ...
        <section id="content-body">
            <div className="wrapper">
                ...
                <center><img alt="AAR" src="https://aar.pausd.org/sites/default/files/aar8.png" height="100" width="100" /></center>
            </div>
            <div className="wrapper">
                <h2>The Brain</h2>
                ...
                <center><img alt="Brainwaves App" src={require('../images/projects/brainwaves-app.png')} width="200" /></center>
            </div>
            <div className="wrapper">
                <h2>Impact</h2>
